...
function M.parse(arg)
  ...
  cmd:option('-sampler_batch_size', 64,
  ...
  -- Data input settings
  cmd:option('-data_h5', 'data/VG-regions_R2longv3.h5', 
    'HDF5 file containing the preprocessed dataset (from proprocess.py)')
  cmd:option('-data_json', 'data/VG-regions-dicts_R2longv3.json',
  ...
  -- Optimization
  cmd:option('-learning_rate', 1e-6, 'learning rate to use')
  ...
  cmd:option('-test_num_proposals', 50,
